...
================================
-Filter_sea_level 
-run_Filter_sea_level.sh (shell script for temporarily setting environment variables and 
                          executing the application)
   -to run the shell script, type
   
       ./run_Filter_sea_level.sh <mcr_directory> <argument_list>

	<argument_list> : /home/nico/MATLAB/MATLAB_Compiler_Runtime/v81/ jsonfilewithlevelvalues Filter_sea_level_pars.mat output.json timestamp_image/shoreline_toprocess 


	ex.	 ./Filter_sea_level_15MIN/run_Filter_sea_level.sh /home/nico/MATLAB/MATLAB_Compiler_Runtime/v81/ json_ex_Nico_15MIN.json Filter_sea_level_pars.mat values.json 1450252800
    ...
    /mathworks/home/application/v81, run the shell script as:
       ...
       ./run_Filter_sea_level.sh /mathworks/home/application/v81
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_Filter_sea_level.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_Filter_sea_level.sh 
