function [gPb_orient] = globalPb_pieces_lum(imgFile, outFile, overlap, piece_size)
...
for i = 1 : nb_pieces
    globalPb_Luminance(sprintf('%s_img%d.png',pieceFilePat,i), sprintf('%s_img%d.mat',pieceFilePat,i));
end
