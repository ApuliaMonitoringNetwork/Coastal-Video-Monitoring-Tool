...
if size(im,3) == 3,
    	weights = [0.0048  0.0047   0.0054  0.0025  0.0023  0.0041  0.0177  0.0204  0.0185   0.0025  0.0026  0.0282 ];
%weigthUpgradedMultitelServer
	weights = [ 0.00466  0.00804   0.00485  0.00091  0.00085  0.00073    0.0483  0.0345   0.0246    0.0021  0.00141  0.0042   ];
else
    im(:,:,2)=im(:,:,1);im(:,:,3)=im(:,:,1);
