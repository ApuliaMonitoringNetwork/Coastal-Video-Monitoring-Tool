function [mPb_nmax, mPb_nmax_rsz, bg1, bg2, bg3, cga1, cga2, cga3, cgb1, cgb2, cgb3, tg1, tg2, tg3, textons] = multiscalePb_Luminance(im, rsz)
...
if size(im,3) == 3,
    ...
    weights = [0.0283  0.0275   0.0216   0.0025  0.0023  0.0031  0.0104    0.00985    0.00466   0.0021  0.00141  0.0042   ];
