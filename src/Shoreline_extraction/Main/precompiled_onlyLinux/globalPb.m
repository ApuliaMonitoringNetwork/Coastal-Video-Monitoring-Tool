...
if nchan == 3,
    %initial values weights = [0  0  0.0039  0.0050  0.0058  0.0069  0.0040  0.0044  0.0049  0.0024  0.0027  0.0170  0.0074];
   weights = [0.0016  0.0014  0.0010  0.00020  0.00022  0.00030   0.0059  0.0048  0.003   0.00054  0.000727  0.000840  0.0072];
